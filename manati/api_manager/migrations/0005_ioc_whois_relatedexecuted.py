...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('analysis_sessions','0029_auto_20170627_0944'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analysis_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='analysis_sessions.AnalysisSession')),
                ('ioc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='analysis_sessions.IOC')),
            ],
            options={
