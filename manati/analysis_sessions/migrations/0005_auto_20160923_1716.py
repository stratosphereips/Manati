...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('analysis_sessions','0004_auto_20160921_1543'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='weblog',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='analysis_sessions.Weblog'),
        ),
        migrations.AddField(
            model_name='analysissessionusers',
            name='analysis_session',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='analysis_sessions.AnalysisSession'),
        ),
        migrations.AddField(
            model_name='analysissessionusers',
            name='user',
        ...
        migrations.AddField(
            model_name='analysissession',
            name='users',
            field=models.ManyToManyField(through='analysis_sessions.AnalysisSessionUsers', to=settings.AUTH_USER_MODEL),
        ),
    ]
