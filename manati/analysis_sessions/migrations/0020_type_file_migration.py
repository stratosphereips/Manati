...
from manati.analysis_sessions.models import Weblog,AnalysisSession
import json
...
def add_type_file_all_analysis_session(apps, schema_editor):
    # AnalysisSession = apps.get_registered_model('analysis_sessions','AnalysisSession')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('analysis_sessions','0019_whois_related_weblog'),
    ]
