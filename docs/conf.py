# ManaTI Project documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = 'ManaTI Project'
copyright = """2018, Raul Benitez Netto"""
...
latex_documents = [
    ('index',
     'manati.tex',
     'ManaTI Project Documentation',
     """Raul Benitez Netto""", 'manual'),
]
...
man_pages = [
    ('index', 'manati', 'ManaTI Project Documentation',
     ["""Raul Benitez Netto"""], 1)
]
